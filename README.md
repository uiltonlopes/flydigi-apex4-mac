...
Download `Apex4-<version>.dmg` from the [Releases](https://github.com/uiltonlopes/flydigi-apex4-mac/releases)
page, drag the app to Applications and follow [`docs/install.md`](docs/install.md) (first launch needs
right-click → Open; XInput mode needs the bundled helper). Changes per version: [`CHANGELOG.md`](CHANGELOG.md).
